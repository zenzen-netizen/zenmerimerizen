...
Strategy: strategy, strategyLock (default|spot|bid_ask|curve — "default"=flexible, else every deploy is force-locked to that strategy), dualSideEnabled (OFF by default — when ON, single-sided SOL deploys auto-add a small quote-side leg for swap-flexibility; swapped positions notified with 🔄), binsBelow, minBinsBelow, maxBinsBelow, defaultBinsBelow
